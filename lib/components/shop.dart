...
class _ShopScreenState extends State<ShopScreen> {
  ...
  Widget build(BuildContext context) {
    // Color neón azul de los 90s
    final neonBlue = Color(0xFF00FFFF); // Cyan neón
    final darkBlue = Color(0xFF001122); // Azul muy oscuro
    final neonBlueGlow = Color(0xFF00FFFF).withOpacity(0.8);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        TextButton.icon(
                          ...
                          icon: Icon(Icons.add_circle, color: neonBlue, size: 16),
                          label: Text(
                            'Monedas gratis',
                            style: TextStyle(
                              color: neonBlue,
      ...
      children: [
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                left: BorderSide(color: neonBlue, width: 4),
    ...
    return Card(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(4),
          border: Border.all(
            color: canBuy ? neonBlue : Colors.grey.shade800,
            width: 2,
          ),
          boxShadow: canBuy ? [
            BoxShadow(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.black,
                        side: BorderSide(
                          color: canBuy ? neonBlue : Colors.grey.shade700,
                          width: 2,
                        ),
                        shape: RoundedRectangleBorder(
                      ...
                      child: Container(
                        decoration: canBuy ? BoxDecoration(
                          boxShadow: [
                            BoxShadow(
                              color: neonBlueGlow,
                              blurRadius: 8,
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: canBuy ? neonBlue : Colors.grey.shade600,
                            fontWeight: FontWeight.bold,
                            fontSize: 11,
                            letterSpacing: 1,
                            shadows: canBuy ? [
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.credit_card, color: neonBlue),
                    filled: true,
                    fillColor: darkBlue,
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'MM/AA',
                          labelStyle: TextStyle(color: neonBlue.withOpacity(0.8)),
                          prefixIcon: Icon(Icons.calendar_today, color: neonBlue),
                          filled: true,
                          fillColor: darkBlue,
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(2),
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'CVV',
                          labelStyle: TextStyle(color: neonBlue.withOpacity(0.8)),
                          prefixIcon: Icon(Icons.lock, color: neonBlue),
                          filled: true,
                          fillColor: darkBlue,
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(2),
